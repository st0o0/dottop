...
public class UpdateService
{
    ...
    private const string Repo = "dtop";
    ...
    public async Task CheckForUpdatesAsync()
    {
        try
        {
            Http.DefaultRequestHeaders.UserAgent.TryParseAdd("dtop");
    ...
    public async Task<bool> PerformUpdateAsync(Action<string>? onProgress = null)
    {
        ...
        try
        {
            ...
            var tempDir = Path.Combine(Path.GetTempPath(), "dtop-update");
            ...
            var exeName = isWindows ? "dtop.exe" : "dtop";
